...
\enddata
\tablecomments{Low-gravity L dwarfs not included in templates and are shown in Figure~\ref{fig:lowg_excluded}. \added{These data are available as Data behind the Figures and from the BDNYC Database.}}
