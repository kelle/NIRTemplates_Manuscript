...
\colhead{} & \colhead{} &  \colhead{} & \colhead{Obs Date}  & \colhead{Optical} & \colhead{Sp. Type} & \colhead{Discovery Ref and Previous} \\

\colhead{Object} & \colhead{Telescope} & \colhead{Instrument} &  \colhead{(UT)} & \colhead{Sp. Type} & \colhead{Ref.} & \colhead{Spectral Type	} 
}
\startdata     
