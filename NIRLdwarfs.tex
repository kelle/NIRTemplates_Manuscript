...
%\textbf{Previously assigned NIR spectral types are discussed in \S~\ref{sec:typing}.}
%Since one of the primary purposes of our analysis is to use the optical data to inform the analysis of the NIR data, we elected to not keep track of other NIR types} in the literature \citep[e.g.,][]{Geballe02, Allers:2013hk, Marocco:2013kv, Gagne:2015dc}.
...
\subsubsection{Comparing NIR to Optical Spectral Types}

\textbf{talk about Figure~\ref{fig:optical NIR comparison}.
}
...
\begin{figure}
  ...
  \caption{\emph{Right}: \textbf{Comparison between Cruz NIR spectral types and optical spectral types in the top panel is contrasted against the comparison between NIR spectral types found previously in the literature and optical spectral types.}
    \emph{Left}: \textbf{Comparison between Cruz NIR spectral types and literature NIR spectral types in the top panel is contrasted against the comparison between optical and literature spectral types.}}
