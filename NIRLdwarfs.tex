...
With this plotting method, the color term present in the NIR spectra of L~dwarfs is approximated as a three component piece-wise step function.
...
\textbf{method is well justified because it needs to work with data obtained by the spectrographs used to study exoplanets, e.g., GPI and SPHERE.
