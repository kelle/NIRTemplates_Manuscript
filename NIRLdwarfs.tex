...
The FITS spectra can be found as Data behind the Figure and from the BDNYC Database.}
\figsetgrpend
...
\figsetgrpstart
\figsetgrpnum{1.8}
\figsetgrptitle{Spectrum of 0624-4521}
\figsetplot{0624-4521_1187.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
The FITS spectra can be found as Data behind the Figure and from the BDNYC Database.}
\figsetgrpend
...
%    \plotone{0624-4521_1187.pdf}
  \caption{New far-red optical spectra listed in Table~\ref{tab:newopt}. Unlike many spectra of L dwarfs, these data have been telluric corrected. The FITS spectra can be found as Data behind the Figure and from the BDNYC Database. The complete figure set (19 images) is available in the electronic edition of the Journal.\label{fig:newopt}}
\end{figure}
...
\replaced
{The low-gravity templates are shown in Figures~\ref{fig:beta_templates}--\ref{fig:gamma_templates} and the targets included in them are listed in Table~\ref{tab:lowg_template}.}
{Low-gravity templates were produced following the same procedure for our field gravity templates.
These are shown in Figures~\ref{fig:beta_templates}--\ref{fig:gamma_templates}, with the targets included in them are listed in Table~\ref{tab:lowg_template}.}
The spectra rejected from the low-gravity templates are shown in Figure~\ref{fig:lowg_excluded} and listed in Table~\ref{tab:lowg_excluded}.

\replaced{Of the~\optLowG, only two were excluded from the templates and all primarily due to the low signal-to-noise ratio of their NIR spectra, rather than because of their inconsistent spectral morphology}{Of the~\optLowG~low-gravity spectra available, only two were excluded from the templates. They were excluded primarily due to the low signal-to-noise ratio of their NIR spectra} (Table~\ref{tab:lowg_excluded}, Figure~\ref{fig:lowg_excluded}).
...
\added{These data are all are available as supplementary material and from the BDNYC Database.}
...
\figsetgrpstart
\figsetgrpnum{A1.1}
\figsetgrptitle{00110940+5149236}
\figsetplot{0011+5149_239.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 00110940+5149236 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.2}
\figsetgrptitle{02561474+1935213}
\figsetplot{0256+1935_268.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 02561474+1935213 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.3}
\figsetgrptitle{02562362+2013457}
\figsetplot{0256+2013_269.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 02562362+2013457 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.4}
\figsetgrptitle{04214954+1528598}
\figsetplot{0421+1528_274.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 04214954+1528598 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.5}
\figsetgrptitle{05151593-0656262}
\figsetplot{0515-0656_276.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 05151593-0656262 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.6}
\figsetgrptitle{05574102-1333264}
\figsetplot{0557-1333_182.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 05574102-1333264 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.7}
\figsetgrptitle{05574229-1333156}
\figsetplot{0557-1333_183.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 05574229-1333156 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.8}
\figsetgrptitle{05583706-1339123}
\figsetplot{0558-1339_184.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 05583706-1339123 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.9}
\figsetgrptitle{12475047-0152142}
\figsetplot{1247-0152_202.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 12475047-0152142 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.10}
\figsetgrptitle{12490476-3454014}
\figsetplot{1249-3454_294.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 12490476-3454014 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.11}
\figsetgrptitle{13570485-3946356}
\figsetplot{1357-3946_296.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 13570485-3946356 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.12}
\figsetgrptitle{15063706+2759544}
\figsetplot{1506+2759_302.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 15063706+2759544 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.13}
\figsetgrptitle{17213581-0619145}
\figsetplot{1721-0619_309.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 17213581-0619145 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.14}
\figsetgrptitle{20151370-1252571}
\figsetplot{2015-1252_222.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 20151370-1252571 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.15}
\figsetgrptitle{22400942+3848306}
\figsetplot{2240+3848_245.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 22400942+3848306 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.16}
\figsetgrptitle{22433237-1525260}
\figsetplot{2243-1525_235.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 22433237-1525260 identified as likely galaxy.}
\figsetgrpend

\figsetgrpstart
\figsetgrpnum{A1.17}
\figsetgrptitle{23490528+1833150}
\figsetplot{2349+1833_324.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS target 23490528+1833150 identified as likely galaxy.}
\figsetgrpend
...
\begin{figure}
    ...
    \caption{Normalized NIR spectra of 2MASS targets identified as likely galaxies. \added{These data are available as Data behind the Figure.} The complete figure set (17 images) is available in the Figure Set in the electronic edition of the journal.}
    \label{fig:notMs_1}
\end{figure}
