...
%three samples
We divided the optical-NIR sample (\optsample) into three subsamples based on their optical spectral morphology: 
...
For the field gravity L1 template, a $\chi^2$ limit of two excludes mostly bluer objects and does not result in a representative sample of field L1 objects being included in the template.
...
As yet, our optical-NIR sample does not include an L2$\beta$ and only includes one each of L3$\beta$ and L4$\beta$, \object[04070752+1546457]{04070752+1546457} and \object[G196-3B]{G196-3B} \citep{Cruz09_lowg}.
