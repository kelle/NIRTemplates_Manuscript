...
\figsetplot{optspec/0032-4405_1093.pdf}
...
\figsetplot{optspec/0055+0134_1103.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/0117-3403_470.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/0210-3015_1125.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/0241-0326_496.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/0518-2756_578.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/0536-1920_586.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1331+3407_1301.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1538-1953_400.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1551+0941_1353.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1551+0941_401.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1615+4953_874.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1615+4953_403.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1711+2326_404.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/1726+1538_405.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/2034+0827_420.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/2137+0808_408.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/2249+0044_1521.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\figsetplot{optspec/2315+0617_1503.pdf}
\figsetgrpnote{New far-red optical spectra listed in Table~\ref{tab:newopt}.
Unlike many spectra of L dwarfs, these data have been telluric corrected.
These data are publicly available from the RIZzo Spectral Library.}
\figsetgrpend
...
\begin{figure}[b]
  \epsscale{0.5}
    \plotone{optspec/0032-4405_1093.pdf}
    \plotone{optspec/0055+0134_1103.pdf}
    \plotone{optspec/0117-3403_470.pdf}
    \plotone{optspec/0210-3015_1125.pdf}
...
\begin{figure}
  \figurenum{3.2}
  \epsscale{0.5}
  \plotone{optspec/0241-0326_496.pdf}
    \plotone{optspec/0518-2756_578.pdf}
   \plotone{optspec/0536-1920_586.pdf}
    \plotone{optspec/1331+3407_1301.pdf}
    \plotone{optspec/1538-1953_400.pdf}
    \plotone{optspec/1551+0941_1353.pdf}
    \plotone{optspec/1551+0941_401.pdf}
    \plotone{optspec/1615+4953_403.pdf}
...
\begin{figure}
  \figurenum{3.3}
  \epsscale{0.5}
  \plotone{optspec/1615+4953_874.pdf}
    \plotone{optspec/1711+2326_404.pdf}
   \plotone{optspec/1726+1538_405.pdf}
    \plotone{optspec/2034+0827_420.pdf}
    \plotone{optspec/2137+0808_408.pdf}
    \plotone{optspec/2249+0044_1521.pdf}
    \plotone{optspec/2315+0617_1503.pdf}
    \caption{New far-red optical spectra continued. Will be electronic only.}
\end{figure}
\clearpage
...
\begin{figure}
  \epsscale{0.90}
  \plotone{plots/L1F_fan.pdf}
  \plotone{plots/L1F.pdf}
...
\begin{figure}
  \epsscale{0.9}
  \plotone{plots/L0strip_f.pdf}
  \plotone{plots/L1strip_f.pdf}
  \plotone{plots/L2strip_f.pdf}
...
\begin{figure}
  \figurenum{5.2}
  \plotone{plots/L3strip_f.pdf}
  \plotone{plots/L4strip_f.pdf}
  \plotone{plots/L5strip_f.pdf}
  \caption{Field templates continued.}
\end{figure}

\begin{figure}
  \figurenum{5.3}
  \plotone{plots/L6strip_f.pdf}
  \plotone{plots/L7strip_f.pdf}
  \plotone{plots/L8strip_f.pdf}
  \caption{Field templates continued.}
\end{figure}

\begin{figure}
  \epsscale{0.9}
  \plotone{plots/L0strip_f_excluded.pdf}
  \plotone{plots/L1strip_f_excluded.pdf}
  \plotone{plots/L2strip_f_excluded.pdf}
...
\begin{figure}
  \figurenum{6.2}
  \plotone{plots/L3strip_f_excluded.pdf}
  \plotone{plots/L4strip_f_excluded.pdf}
  \plotone{plots/L5strip_f_excluded.pdf}
  \caption{Excluded field object continued.}
\end{figure}

\begin{figure}
  \figurenum{6.3}
  \plotone{plots/L6strip_f_excluded.pdf}
  \plotone{plots/L7strip_f_excluded.pdf}
  \plotone{plots/L8strip_f_excluded.pdf}
...
\begin{figure}
  \epsscale{0.9}
  \plotone{plots/L0strip_b.pdf}
  \plotone{plots/L1strip_b.pdf}
...
\begin{figure}
  \epsscale{0.9}
  \plotone{plots/L0strip_g.pdf}
  \plotone{plots/L1strip_g.pdf}
  \plotone{plots/L2strip_g.pdf}
...
\begin{figure}
  \figurenum{8.2}
  \plotone{plots/L3strip_g.pdf}
  \plotone{plots/L4strip_g.pdf}
  \caption{Low gravity $\gamma$ templates continued.}
\end{figure}

\begin{figure}
  \epsscale{0.9}
  \plotone{plots/L0strip_b_excluded.pdf}
  \plotone{plots/L0strip_g_excluded.pdf}
...
\begin{figure}
    \epsscale{1}
    \plotone{plots/sequence0_f.pdf}
    \plotone{plots/sequence1_f.pdf}
...
\begin{figure}[b]
    \epsscale{1}
    \plotone{plots/templates-L0g.pdf}
...
\begin{figure}[b]
    \plotone{plots/templates-L0b.pdf}
...
\begin{figure}[b]
        \plotone{plots/templates-L1g.pdf}
...
\begin{figure}
  \figurenum{15.2}
  \plotone{plots/templates2-L1g.pdf}
...
\begin{figure}[b]
    \plotone{plots/templates-L1b.pdf}
...
\begin{figure}[b]
    \plotone{plots/templates-L2g.pdf}
...
\begin{figure}
  \figurenum{17.2}
  \plotone{plots/templates2-L2g.pdf}
...
\begin{figure}[b]
  \plotone{plots/templates-L3g.pdf}
...
\begin{figure}
    \figurenum{18.2}
     \plotone{plots/templates2-L3g.pdf}
...
\begin{figure}[b]
    \plotone{plots/templates-L4g.pdf}
...
\begin{figure}
     \figurenum{19.2}
     \plotone{plots/templates2-L4g.pdf}
...
\begin{figure}[hb!]
        \plotone{plots/templates-stds.pdf}
...
\begin{figure}
        \plotone{plots/templates-stdsL2L7.pdf}
...
\figsetplot{plots/notM_galaxies1.pdf}
...
\figsetplot{plots/notM_galaxies2.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS targets identified as likely galaxies.}
\figsetgrpend
...
\figsetplot{plots/notM_emln_galaxies.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS targets identified as likely galaxies.}
\figsetgrpend
...
\begin{figure}
    \epsscale{1}
    \plotone{plots/notM_galaxies1.pdf}
