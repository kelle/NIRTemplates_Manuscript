...
\end{itemize}
A great deal of further theoretical and observational work is needed to pinpoint the nature of the physical properties modulating the spectral morphologies and colors of L dwarfs.

We have used optically-anchored NIR spectral average templates to evaluate the current suite of field and low-gravity NIR spectral standards proposed by \cite{Kirkpatrick10} and \cite{Allers:2013hk}. 
We have suggested alterante and secondary standards where previously proposed standards have turned out to be non-representative of the population or where brighter, more accessible suitable standards exist.
...
Further, more objects are required to make the low-gravity $\beta$ spectral sequence more robust and to extend the $\gamma$ sequence later than L4$\gamma$.
