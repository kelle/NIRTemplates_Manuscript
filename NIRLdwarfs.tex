...
\begin{figure}[b]
  ...
  \caption{New far-red optical spectra listed in Table~\ref{tab:newopt}. Unlike many spectra of L dwarfs, these data have been telluric corrected. These data are publicly available from the BDNYC Database. Additional images are available in the Figure Set in the electronic edition of the journal.\label{fig:newopt}}
\end{figure}
