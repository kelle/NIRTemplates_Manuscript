...
The spectra are shown in Figure Set~\ref{fig:newopt} and are publicly available from the BDNYC Database\footnote{The BDNYC Database: \url{http://database.bdnyc.org/}}.
