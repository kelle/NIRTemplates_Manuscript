...
\replaced{Common practice is to normalize }{Most previous analyses have normalized } NIR spectra of L~dwarfs at the \emph{zJ}-band peak (1.28--1.32~$\micron$, e.g., K10). %\citep[e.g.,][]{Kirkpatrick10}.
...
The authors would like to thank J. Davy Kirkpatrick and Michael Cushing for useful discussions and Eileen Gonzales and Victoria DiTomasso for assistance compiling the references.
