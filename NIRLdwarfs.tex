...
This process was iterated 3--6 times until no additional objects were rejected and the reduced $\chi^2$ values stabilized. \textbf{The code used to make the templates is available on GitHub\footnote{Code used to generate templates: \url{https://github.com/kelle/Make_NIRTemplates}.}.}
