...
In order to give a general sense of the pre-existing NIR types for objects in the optical-NIR sample, we have identified the objects that are included in the SpeX Prism Library Analysis Toolkit (SPLAT)\footnote{SpeX Prism Library Analysis Toolkit (SPLAT): \url{http://www.browndwarfs.org/splat}} with a listed NIR spectral type.
We have recovered 78 objects in the optical-NIR sample in SPLAT with NIR types. (The types originate from 17 different papers but they are predominately from \citet{Knapp04}, \citet{Allers:2010cg}, \citet{Kirkpatrick10}, and \citet{Gagne:2015dc}.)
...
\textbf{We used SPLAT to identify previously assigned NIR spectral types in the literature for objects in the optical-NIR sample.
Results for 78 objects in Figure~\ref{fig:opt_lit_nir_comparison}.
Literature types tend to be later than the optical types.
Also lots of differences in suffix.}
...
\begin{figure}
  %\plotone{optical_comparison.pdf}
  %\plotone{literature_comparison.pdf}
