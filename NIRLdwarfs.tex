...
We present \NewPrismSpectra~new SpeX prism spectra of \NewPrismObjects~L dwarfs. Of these, \NewPrisminSample~are included in the optical-NIR sample.
...
These data are available in the supplementary tar.gz archives and from SPLAT and the BDNYC Database.
