...
\begin{figure}
	...
	\caption{The L0$\beta$ spectral average template (blue) compared to the field L dwarf templates and their 1$\sigma$ variance (black, gray). We assert that in order to use NIR spectra to credibly distinguish an L0$\beta$ from a field object in the NIR.}
	\label{fig:L0b-field}
\end{figure}

\begin{figure}
	\plotone{/Users/kelle/Dropbox/Analysis/NIRtemplates/NIRSpecFigures/plots/templates-L1b.pdf}
	\caption{The L1$\beta$ spectral average template (red) compared to the field L dwarf templates and their 1$\sigma$ variance (black, gray). We assert that in order to use NIR spectra to credibly distinguish an L0$\beta$ from a field object in the NIR.}
	\label{fig:L1b-field}
\end{figure}
