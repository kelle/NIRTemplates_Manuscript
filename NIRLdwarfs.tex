...
\author{Kelle L. Cruz\altaffilmark{1,2,3,4}}
...
\author{Alejandro N\'{u}\~{n}ez\altaffilmark{1,2,4,5}}
\affil{Department of Astronomy, Columbia University, 550 West 120th Street, New York, NY 10027, USA}
\author{Adam J. Burgasser\altaffilmark{6}} %SpeX Data & template code
...
\author{Emily L. Rice\altaffilmark{2,3,8}} %introduction and conclusions
...
\author{I. Neill Reid\altaffilmark{4,9}} %IRTF observations
...
The authors would like to thank Davy Kirkpatrick for useful discussions.
...
{\it Facilities:} \facility{IRTF (SpeX)}, \facility{Keck:: (LRIS)}, \facility{Magellan:Clay (LDSS3)}
