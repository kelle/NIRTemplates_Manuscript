...
\author{Emily L. Rice} %introduction and conclusions
...
\author{I. Neill Reid} %IRTF observations
\altaffiliation{Visiting Astronomer at the Infrared Telescope Facility, which is operated by the University of Hawaii under Cooperative Agreement no. NCC 5-538 with the National Aeronautics and Space Administration, Science Mission Directorate, Planetary Astronomy Program.}
...
\begin{abstract}
\textbf{Discrepancies between competing optical and near-infrared (NIR) spectral typing systems for L dwarfs have motivated us to search for a classification scheme which ties the optical and NIR schemes \edit2{together,} and addresses complexities in the spectral morphology.}
...
\edit2{They also} show the range of spectral morphologies spanned by each spectral type.
...
\edit2{There are also L subdwarfs and so-called ``blue'' L dwarfs with low metalliticy and old ages.  
...
\edit2{We did not attempt to normalize using a smooth function.}
\deleted{One could imagine trying to de-redden each band using a reddening curve.
...
This process was iterated 3--6 times until no additional objects were rejected and the \replaced{reduced $\chi^2$}{$M$} values stabilized. \textbf{The code used to make the templates is available on GitHub\footnote{Code used to generate templates: \url{https://github.com/kelle/Make_NIRTemplates}.}.}
