...
%NIR
\newcommand{\NewPrismSpectra}{130} %New Prism Data
%\newcommand{\dupes}{18} % Duplicates & Breakdown
\newcommand{\NewPrismObjects}{109} % New Prism Breakdown
...
We use new and extant optical and NIR spectra to compile a sample of~\sample~L dwarfs with spectral coverage from 0.6-–2.4$\micron$, including \optLowG~low gravity $\beta$ and $\gamma$ objects.
...
The later type $\gamma$ type objects (e.g., \objectname[2MASS J03552337+1133437]{2M0355+1133},\citet{Cruz09_lowg}) display significant spectral diversity and we defer an analysis of these data to a future paper.
...
This process was iterated 3--6 times until no additional objects were rejected and the reduced $\chi^2$ value stabilized.
...
\begin{figure}
  \figurenum{15.2}
  \plotone{/Users/kelle/Dropbox/Analysis/NIRtemplates/NIRSpecFigures/plots/templates2-L1g.pdf}
...
\begin{figure}
  \figurenum{17.2}
  \plotone{/Users/kelle/Dropbox/Analysis/NIRtemplates/NIRSpecFigures/plots/templates2-L2g.pdf}
...
\begin{figure}
    \figurenum{18.2}
     \plotone{/Users/kelle/Dropbox/Analysis/NIRtemplates/NIRSpecFigures/plots/templates2-L3g.pdf}
...
\begin{figure}
     \figurenum{19.2}
     \plotone{/Users/kelle/Dropbox/Analysis/NIRtemplates/NIRSpecFigures/plots/templates2-L4g.pdf}
...
\figsetplot{figures/notM_galaxies1.pdf}
...
\figsetplot{figures/notM_galaxies2.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS targets identified as likely galaxies.}
\figsetgrpend
...
\figsetplot{figures/notM_emln_galaxies.pdf}
\figsetgrpnote{Normalized NIR spectra of 2MASS targets identified as likely galaxies.}
\figsetgrpend
