...
We present \NewPrismSpectra new low-resolution NIR spectra and ~\newOptSpectra~new optical spectra.
...
We re-evaluate NIR spectral standards of \cite{Kirkpatrick10} and \cite{Allers:2013hk} in light of the templates and propose some new standard objects.
Finally, we build on the spectral typing method of \cite{Kirkpatrick10} to provide a method for estimating spectral types for L dwarfs when only $H$- or $K$-band data are available.
\end{abstract}
