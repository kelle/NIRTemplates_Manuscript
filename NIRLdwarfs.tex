...
\author{Ellianna Abrahams} %nir spectral types comparsion
\affil{Department of Astrophysics, American Museum of Natural History, Central Park West & 79th St., New York, NY, 10024, USA}
\affiliation{Department of Physics, City College of New York, City University of New York, New York, NY}
...
These data are available as Data behind the Figure and from the BDNYC Database.}
\figsetgrpend
...
\begin{figure}[b]
  ...
  \caption{New far-red optical spectra listed in Table~\ref{tab:newopt}. Unlike many spectra of L dwarfs, these data have been telluric corrected. These data are available \added{as Data behind the Figure} and from the BDNYC Database. Additional images are available in the Figure Set in the electronic edition of the journal.\label{fig:newopt}}
\end{figure}
