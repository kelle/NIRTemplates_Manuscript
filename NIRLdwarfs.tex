...
\begin{figure}
  ...
  \caption{\emph{Right}: Comparison between Cruz NIR spectral types and optical spectral types in the top panel is contrasted against the comparison between NIR spectral types found previously in the literature and optical spectral types.
    \emph{Left}: Comparison between Cruz NIR spectral types and literature NIR spectral types in the top panel is contrasted against the comparison between optical and literature spectral types.}
