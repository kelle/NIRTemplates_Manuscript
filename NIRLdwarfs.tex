...
Since one of the primary purposes of our analysis is to use the optical data to inform the analysis of the NIR data, \textbf{we elected to not keep track of other NIR types} in the literature \citep[e.g.,][]{Geballe02, Allers:2013hk, Marocco:2013kv, Gagne:2015to}.
...
\textbf{The later type and earlier type spectra display a similar degree of homogeneity (as reflected in the templates by the flux range and 1$\sigma$ dispersion at each pixel), even though the former include a higher fraction of objects in the templates.}
