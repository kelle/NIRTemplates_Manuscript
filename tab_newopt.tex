...
\tablehead{
\colhead{2MASS}       & \colhead{}          &  \colhead{}          & \colhead{Obs Date}  & \colhead{Optical} & \colhead{Sp. Type} & \colhead{Discovery and Previous} \\
...
15382417$-$1953116  &   Keck I	& LRIS &	2010 Jul 17  & L4$\gamma$	& \cite{Faherty:2016fx}	&            \\
...
\tablecomments{Spectra shown in Figure Set~\ref{fig:newopt} and publicly available from the RIZzo Spectral Library.}
