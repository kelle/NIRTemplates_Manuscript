...
\emph{Includes \\
Figures~\ref{fig:spthist}, \ref{fig:JK_colors}, \ref{fig:beta_templates}, \ref{fig:gamma_templates}, \ref{fig:lowg_excluded}, \ref{fig:lg_sequence} \\
...
However, the two distributions have notable overlap.
There are many objects with quite red colors for their spectral type that do not have any recognize signatures of low gravity in their optical or low-resolution NIR spectra.
These data further support the notion that most low gravity objects are red, but not all red objects are low gravity.
While diversity of cloud properties is often pointed to as the primary suspect, much work is warranted to pinpoint the nature of the physical properties modulating the $J-K_S$ colors of L dwarfs.
