...
Here, we build on the utility of the K10 spectral standards and suggest a method for estimating optically-anchored spectral types for L dwarfs based solely on NIR data, especially when high quality $J$-band data is not available. 
...
chose betas and gammas in the optical even though NIR spectra are very similar.

and not at extreme north or south dec. Choose two L0 gammas due to 0141 being at -46

Table~\ref{tab:lg_standards}.
