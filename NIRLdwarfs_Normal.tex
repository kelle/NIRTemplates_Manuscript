...
Despite common misconception, they define the beginning of the T dwarf sequence in the NIR as the first appearance of the 1.6$\micron$ methane absorption feature in the $H$ band, not the $K$ band.
...
It is also possible that at the cooler temperatures/later types, the role of small dust grains in the photospheres becomes more important and small changes in those dust properties have a larger impact on the emergent spectra \citep{Marocco:2014kr,Hiranaka:2015va}.
\end{itemize}
...
Despite the red bias of the optical-NIR sample and the small numbers of late type objects, the striking homogeneity of the spectra at each spectral type give us confidence in the template's representation of the field L dwarf population's NIR spectral morphology.
Further, given this homogeneity, we do not expect the templates to change significantly as more objects are discovered and data are acquired. 
...
\label{sec:temp}
The field L dwarf $zJ$, $H$, and $K_S$ low-resolution spectral templates described in the previous subsection are shown overplotted on top of each other in Figure~\ref{fig:spec_sequence}. 
...
One of the potential uses of these templates is to reliably distinguish field-gravity L dwarfs from low-gravity and potentially young L dwarfs. 
