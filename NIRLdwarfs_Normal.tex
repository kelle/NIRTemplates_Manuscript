...
In principal, we could set up three spectral typing schemes, one for each band, but for simplicity, we propose adopting a range of optically-anchored specral types for $H$ or $K$-band only data.
