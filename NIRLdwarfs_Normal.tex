...
\begin{itemize}
	...
	\item The L9 NIR standard, \object{2MASS 0255-4700}, is classified as an L8 in the optical and is included in the L8 template. (Our analysis is anchored in the optical and since the L9 subclass is only defined for NIR data, we do not have an L9 template.) 
