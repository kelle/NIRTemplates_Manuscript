...
Dagny Looper,
%using her data
I. Neill Reid\altaffilmark{3,4,5}
}
...
The full sample is divvied up into Tables~\ref{tab:normal_template}--\ref{tab:lowg_excluded} and we refer to them collectively as the ``optical-NIR sample''. 
...
The optical spectra were obtained with long-slit spectrographs-telescope combinations all with similar resolution ($\lambda/\Delta\lambda\sim1000$). 
The instrumental setup and data reduction techniques used for each spectrum is described in the references listed in Tables~\ref{tab:normal_template}--\ref{tab:lowg_excluded}.
Every spectrum was visually compared to spectral standards in order to estimate spectral types using the schemes of \citet{K99} and \cite{Cruz09_lowg} for field and low gravity spectra respectively.  The resulting spectral types are listed in Table \ref{tab:newopt}.
...
This process iterated 3-6 times until the chi-squared value stabilize. The average chi2 values of the spectra included in the spectral averages are close to 0.9. A chi2 cutoff of 2 was chosen because it balanced our desire to 1) include more objects than exclude and 2) not include objects with peculiar spectral morphologies. 
...
\begin{figure}
		\plotone{figures/Plots/histogram.pdf}
...
%\begin{landscape}
	...
	\begin{figure}
		\epsscale{1}
		\plotone{figures/Plots/L0strip_f.pdf}
...
\begin{figure}
	\epsscale{1}
	\plotone{figures/Plots/L1strip_f.pdf}
...
\begin{figure}
	\plotone{figures/Plots/L2strip_f.pdf}
...
\begin{figure}
	\plotone{figures/Plots/L3strip_f.pdf}
...
\begin{figure}
		\plotone{figures/Plots/JK_JF.pdf}
...
\begin{figure}
		\plotone{figures/Plots/templates-stds.pdf}
		\caption{
...
\begin{figure}
	\epsscale{1.0}
	\plotone{figures/Plots/L0strip_y.pdf}
...
\begin{figure}
	\epsscale{1.0}
	\plotone{figures/Plots/L1strip_y.pdf}
...
\begin{figure}
	\epsscale{1.0}
	\plotone{figures/Plots/L2strip_y.pdf}
	\caption{L2 low gravity}
	\label{fig:L2lg}
\end{figure}

\begin{figure}
	\plotone{figures/Plots/L3strip_y.pdf}
	\caption{L3 low gravity}
	\label{fig:L3lg}
\end{figure}

\begin{figure}
	\plotone{figures/Plots/L4strip_y.pdf}
	\caption{L4 low gravity}
	\label{fig:L4lg}
\end{figure}

\begin{figure}
	\plotone{figures/Plots/L5strip_y.pdf}
