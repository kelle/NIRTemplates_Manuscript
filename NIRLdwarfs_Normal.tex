...
\emph{Includes //
Figures~\ref{fig:spthist}, \ref{fig:JK_colors}, \ref{fig:beta_templates}, \ref{fig:gamma_templates} //
Tables ~\ref{tab:lowg_template}, \ref{tab:lowg_excluded}, \ref{tab:}.}
...
Of the~\optLowG, only three (listed in Table~\ref{tab:lowg_excluded}) were excluded from the templates and all primarily due to the low signal-to-noise ratio of their NIR spectra, not because of their inconsistent spectral morphology (Figure Set~\ref{tab:lowg_excluded}).
...
The number of objects included in each template, the mean, minimum, maximum, and range of $J-K_S$ colors is listed in Table~\ref{tab:lg_sample_prop}. 
The color distribution of the low-gravity objects is significantly redder than the field gravity objects but the two distributions have significant overlap. 
