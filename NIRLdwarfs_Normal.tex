...
\emph{Includes Figures~\ref{fig:spthist}, \ref{fig:JK_colors}, \ref{fig:beta_templates}--\ref{fig:gamma_templates} 
...
The low-gravity sample is composed of objects from \citet{Cruz09_lowg} and the new data presented in \SS~\ref{sec:obs_new_opt} and~\ref{sec:obs_new_nir}.
...
Of the~\optLowG, only three were excluded from the templates and all primarily due to the low signal-to-noise ratio of their NIR spectra, not because of their inconsistent spectral morphology (Figure Set~\ref{tab:lowg_excluded} and Table~\ref{tab:lowg_excluded}).
