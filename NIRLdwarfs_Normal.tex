...
More earlier type objects are present in the optical-NIR sample for two primary reasons: First, the number densities of earlier type objects are intrinsically higher than later type objects \cite{DayJones:2013hm}. 
...
In Figure~\ref{fig:JK_colors}, we show the 2MASS $J-K_S$ color versus spectral type distribution for the optical-NIR sample of L~dwarfs. 
...
This figure reveals several things of note:
\begin{itemize}
...
This difference cannot entirely be attributed to small number statistics at later types because there are nearly the same number of L5s considered (18) as L3s (20).
...
It is possible that the larger color spread at later types is due to the larger range of underlying masses, ages, and gravities expected in the brown dwarf population compared to the stellar dominated earlier types, which are predicted to have roughly the same masses and gravities and are less sensitive to age.
It is also possible that at the cooler temperatures/later types, the role of small dust grains in the photospheres becomes more important and small changes in those dust properties have a larger impact on the emergent spectra \citep{Morocco, Hiranaka}.
\end{itemize}
